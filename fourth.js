...
import './fourth.css'
import Venn from './images/graphic-mobile.webp'
import Blue from './images/bluetynker.webp'
import Red from './images/redtynker.webp'
import Mod from './images/mod.webp'
import Four from './images/fourstars.jpg'
import FOUR from './images/fourstarsh.jpg'
import Bbc from './images/graphic-bbc.webp'
            ...
            <div className='UpBody'>
                ...
                <div className='UpBodyContent'>
                    <div className='UpBodyPic'>
                        <img src={Venn} alt='sage'/>
                    </div>
                    <div className='UpBodyIcon'>
                        <div className='UpBodyIcon1'>
                            <div className='Avatar'>
                            <img src={Blue} alt='sage'/>
                            </div>
                            <div className='TynkerJunior'>
                            <div className='TynkerJuniorText'>
                                <h1 className='Big'>Tynker Junior</h1>
                                <p class="Drag">Tap-Tap picture coding with voice-overs. Pre-<br/>readers solve story-based puzzles and build their<br/>first programs in coding sandboxes. Ages 5-7</p>
                            </div>
                                <div className='FourStars'>
                                 <img src={Four} alt='sage'/>
                        ...
                        <div className='UpBodyIcon3'>
                            <div className='Avatar'>
                            <img src={Mod} alt='sage'/>
                            </div>
                            <div className='TynkerJunior'>
                            <div className='TynkerJuniorText'>
                                <h1 className='Big'>Mod Creator</h1>
                                <p class="Drag">Drag-and-drop Minecraft modding. Design skins,<br/>blocks and items. Modify mob behaviors. Create<br/>mods and add ons. Explore worlds! Ages 6-11</p>
                            </div>
                                <div className='FourStars'>
                                <img src={FOUR} alt='sage'/>
